...
final PrimaryTextStyle = GoogleFonts.poppins(textStyle: TextStyle(fontSize: 20, fontWeight: FontWeight.w500));

class SelectBranchAndSemesterForSyllabus extends StatefulWidget {
  const SelectBranchAndSemesterForSyllabus({Key? key}) : super(key: key);
  _SelectBranchAndSemesterForSyllabusState createState() =>
      _SelectBranchAndSemesterForSyllabusState();
}

class _SelectBranchAndSemesterForSyllabusState extends State<SelectBranchAndSemesterForSyllabus> {
  int BranchValue = 0;
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              Padding(
                padding:
                    const EdgeInsets.symmetric(horizontal: 93, vertical: 23),
                child: ElevatedButton(
                  ...
                  onPressed: () {
                    ...
                    if (BranchValue == 6) {
                      ...
                      print("You selected Branch $BranchValue and Semester $SemValue");
                    }
                  },
