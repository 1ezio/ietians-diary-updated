...
class SelectBranchAndSemesterForPreviousYearPapers extends StatefulWidget {
  const SelectBranchAndSemesterForPreviousYearPapers({Key? key}) : super(key: key);
  _SelectBranchAndSemesterForPreviousYearPapersState createState() =>
      _SelectBranchAndSemesterForPreviousYearPapersState();
}

class _SelectBranchAndSemesterForPreviousYearPapersState extends State<SelectBranchAndSemesterForPreviousYearPapers> {
  int BranchValue = 0;
